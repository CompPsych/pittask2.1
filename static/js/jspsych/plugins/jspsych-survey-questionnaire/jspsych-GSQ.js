jsPsych.plugins['GSQ'] = (function () {
  ...
  plugin.trial = function (display_element, trial) {
    ...
    var plugin_id_name = "jspsych-survey-multi-choice-GSQ";
    var html = "";
    ...
    // timer module init
    if (jsPsych.pluginAPI.isNeedToStartTimerModuleInitialization(trial.type, 'GSQ')) {
