jsPsych.plugins['NIAS'] = (function () {
  ...
  plugin.trial = function (display_element, trial) {
    ...
    var plugin_id_name = "jspsych-survey-multi-choice-NIAS";
    var html = "";
    ...
    // timer module init
    if (jsPsych.pluginAPI.isNeedToStartTimerModuleInitialization(trial.type, 'NIAS')) {
    ...
    html +=
      `<div id="jspsych-survey-multi-choice-preamble" class="jspsych-survey-multi-choice-instructions">
            ...
            <ul>
              <li><div>Strongly <br> disagree</div></li>
              <li><div>Disagree</div></li>
              <li><div>Slightly <br> disagree</div></li>
              <li><div>Slightly <br> agree</div></li>
              <li><div>Agree</div></li>
              <li><div>Strongly <br> agree</div></li>
            </ul>
      </div>`;
