jsPsych.plugins['ASRS-5'] = (function () {
  ...
  plugin.trial = function (display_element, trial) {
    ...
    var titles = ['Never', 'Rarely', 'Sometimes', 'Often', 'Very often']
    ...
    for (var i = 0; i < trial.questions.length; i++) {
      ...
      // add question text
      html += '<div style="display: flex; align-items: center; width: 40%; padding: 1rem 0;"><span class="jspsych-survey-multi-choice-number">' + (i + 1) + '.</span><p class="jspsych-survey-multi-choice-text survey-multi-choice jspsych-survey-multi-choice-question-text" style="text-align: left; padding: 0 10px; width: 100%;"><span>' + question.prompt
      // question.required
      html += '</span></p></div>';
