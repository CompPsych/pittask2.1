jsPsych.plugins['ISQ'] = (function () {
  ...
  plugin.trial = function (display_element, trial) {
    ...
    var plugin_id_name = "jspsych-survey-multi-choice-ISQ";
    var html = "";
    ...
    // timer module init
    if (jsPsych.pluginAPI.isNeedToStartTimerModuleInitialization(trial.type, 'ISQ')) {
    ...
    html +=
      `<div id="jspsych-survey-multi-choice-preamble" class="jspsych-survey-multi-choice-instructions">
            ...
            <ul>
              <li><div>Not at <br> all true <br> of me <br> 1</div></li>
              <li><div>2</div></li>
              <li><div>3</div></li>
              <li><div>4</div></li>
              <li><div>5</div></li>
              <li><div>6</div></li>
              <li><div>Very <br> true of <br> me <br> 7</div></li>
            </ul>
      </div>`;
    ...
    for (var i = 20, k = 0; i < trial.questions.length; i++, k++) {
      // get question based on question_order
      var question = trial.questions[question_order[i]];
      var question_id = question_order[i];
