...
"<p>Now we would like to ask you some questions.</p><br> <p>Press any key when you are ready.</p>";
...
"Now we would like to ask you some questions about your food preferences.<br>" +
"<p>Press any key to continue. </p>";
var close_instruct_text_FHQ_pre_rating =
"Thank you. That is it for the food questions for now.<p> Press any key to continue. </p>";

var open_instruct_FHQ_post_rating = true;
var close_instruct_FHQ_post_rating = true;
var open_instruct_text_FHQ_post_rating =
"Now we would again like to ask you some questions about your food preferences.<br>" +
"<p>Press any key to continue. </p>";
var close_instruct_text_FHQ_post_rating =
"Thank you. That is it for the food questions.<p> Press any key to continue. </p>";
...
var popup_text_machine_deval_test =
"You can tip the machine any time in this stage. Any snacks you earn will be recorded.";
/************************************************************
 * Recall(memory test)
 ************************************************************/
...
"<p>Thank you!</p><p>Press any key to return to the Amazon Mechanical Turk page.</p>" +
